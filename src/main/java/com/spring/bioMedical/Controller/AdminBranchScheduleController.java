...
public class AdminBranchScheduleController {
    ...
    private Long currentClinicId() {
        ...
        if (username != null) {
            return usersRepository.findOptionalByUsername(username)
    ...
    public String viewDay(Model model,
        ...
        Clinics clinic = clinicRepo.findById(clinicId).orElse(null);
        List<AppointmentSlots> slots = scheduleService.listSlots(clinicId, d);
